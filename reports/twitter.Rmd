...
**Regressões**
Regressao logísitca vitoria e Sentimento do twitter
```{r}
logit <- glm(vitoria ~ sent_twitter_, data = dados)
summary(logit)
```
**Existe uma relação inversa entre a vitoria e o sentimento do instagram**
...
somente universidade e instagram
...
somente instituto federal e instagram
